...
def compute_rewards(
    ...
    # print("right_ee_thumb_angular_distance: ", right_ee_thumb_angular_distance[0])
    # print("left_ee_pinky_angular_distance: ", left_ee_pinky_angular_distance[0])
