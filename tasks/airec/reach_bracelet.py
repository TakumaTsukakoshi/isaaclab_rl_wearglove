...
def compute_rewards(
    ...
    r_right_ee_thumb_distance = distance_reward(right_ee_thumb_euclidean_distance, std=0.4) * reaching_object_goal_scale * (top_height > wrist_height) * (wrist_height < bottom_height) *(ee_euclidean_distance < 0.3) # default 0.4
