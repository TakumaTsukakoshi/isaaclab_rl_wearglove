...
AIREC_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        # Planar-move chassis (held at 0 / zero vel when ``hold_base_fixed``).
        "base_joints": ImplicitActuatorCfg(
            ...
            stiffness={
                "base_joint_trans_x": 5000.0,
                "base_joint_trans_y": 5000.0,
                "base_joint_rot_yaw": 2000.0,
            },
            damping={
                "base_joint_trans_x": 500.0,
                "base_joint_trans_y": 500.0,
                "base_joint_rot_yaw": 200.0,
            },
            velocity_limit_sim={
                "base_joint_trans_x": 0.0,
                "base_joint_trans_y": 0.0,
