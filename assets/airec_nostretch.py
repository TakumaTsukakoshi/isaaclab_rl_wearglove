...
AIREC_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
        # "left_arm_joint_1": radians(13),
        # "left_arm_joint_2": radians(-100),
        # "left_arm_joint_3": radians(0),
        # "left_arm_joint_4": radians(40),
        # "left_arm_joint_5": radians(80),
        # "left_arm_joint_6": radians(-20),
        # "left_arm_joint_7": radians(12),
        "torso_joint_1": radians(-15),
        "torso_joint_2": radians(35),
        "torso_joint_3": radians(0),
        "head_joint_1": radians(0),
        "head_joint_2": radians(40),
        "head_joint_3": radians(0),
        "left_arm_joint_1": radians(15),
        "left_arm_joint_2": radians(-10),
        "left_arm_joint_3": radians(-15),
        "left_arm_joint_4": radians(113),
        "left_arm_joint_5": radians(33),
        "left_arm_joint_6": radians(52),
        "left_arm_joint_7": radians(17),
        "right_arm_joint_1": radians(15),
        "right_arm_joint_2": radians(-10),
        "right_arm_joint_3": radians(-15),
        "right_arm_joint_4": radians(113),
        "right_arm_joint_5": radians(33),
        "right_arm_joint_6": radians(52),
        "right_arm_joint_7": radians(17),
        "left_hand_thumb_joint_1": radians(75),
        "left_hand_thumb_joint_2": radians(19),
        "left_hand_thumb_joint_3": radians(49),
        "left_hand_thumb_joint_4": radians(49),
        "left_hand_first_finger_joint_1": radians(77),
        "left_hand_first_finger_joint_2": radians(0),
        "left_hand_second_finger_joint_1": radians(77),
        ...
        "right_hand_thumb_joint_2": radians(19),
        "right_hand_thumb_joint_3": radians(49),
        "right_hand_thumb_joint_4": radians(49),
        "right_hand_first_finger_joint_1": radians(77),
        "right_hand_first_finger_joint_2": radians(0),
        "right_hand_second_finger_joint_1": radians(77),
